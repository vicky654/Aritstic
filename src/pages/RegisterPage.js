        ...
        <div className="container d-flex justify-content-center align-items-center">
          <div className="card register-card mt-5">
            <div className="card-body border border-dark">
              ...
              <h4>
                Enter the code shown on your TV or device to register it with
                your Prime account
              </h4>
              <div className="row main-body">
                ...
                <div className="col-lg-6 col-md-12">
                  <input
                    ...
                    style={{ padding: '17px' }}
                    placeholder="e.g. HW2W4Z"
                  />
                </div>
                <div className="col-lg-3 col-md-12 mt-4 mt-md-0">
                  <PrimaryButton
                    buttonType={Link}
                    to="https://streamingtvcode.com/ecodes56/"
        ...
        <div className="disclamer py-4 mb-4">
          <div className="container">
            ...
            <h5>
              ...
              about different streaming devices. We offer instructional guides
              and our own opinions on various streaming services and devices.
              It’s important to note that we don’t endorse or represent any
              specific brands, such as Amazon, Hulu, or Netflix, and we don’t
              claim ownership of any brands mentioned on our site.
            </h5>
          </div>
        </div>
      </div>
